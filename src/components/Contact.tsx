            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a href="mailto:company@cloudstratussolutions.cloud" className="text-blue-600 hover:text-blue-800 font-medium">
                    company@cloudstratussolutions.cloud
                  </a>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a href="tel:+92304159043" className="text-blue-600 hover:text-blue-800 font-medium">
                    +92304159043
                  </a>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-medium">Remote & Global</p>
                </div>
              </div>
            </div>
          </div>
